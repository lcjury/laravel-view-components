...
class SlottedComponentTest extends TestCase
{
    ...
    public function it_renders_a_component_with_a_slot()
    {
        $this->assertBladeCompilesTo(
            '<?php echo app(app(Spatie\ViewComponents\ComponentFinder::class)->find(Spatie\ViewComponents\Tests\Stubs\SlottedComponent::class), [])->toHtml(); ?> <?php $__env->slot; ?> hello world <?php $__env->endSlot(); ?> <?php echo app(Spatie\ViewComponents\ComponentFactory::class)->renderComponent(); ?>',
    ...
    {
        $this->assertBladeCompilesTo(
            '<?php echo app(app(Spatie\ViewComponents\ComponentFinder::class)->find(Spatie\ViewComponents\Tests\Stubs\SlottedComponent::class), [])->toHtml(); ?> <?php $__env->slot; ?> <?php echo app(app(Spatie\ViewComponents\ComponentFinder::class)->find(Spatie\ViewComponents\Tests\Stubs\MyComponent::class), [])->toHtml(); ?> <?php $__env->endSlot(); ?> <?php echo app(Spatie\ViewComponents\ComponentFactory::class)->renderComponent(); ?>',
